//
// Generated file, do not edit! Created by nedtool 4.6 from plpdu.msg.
//
...
int P_PDU::getSadd() const
{
    return sadd_var;
}

void P_PDU::setSadd(int sadd)
{
    this->sadd_var = sadd;
}

int P_PDU::getDadd() const
{
    return dadd_var;
}

void P_PDU::setDadd(int dadd)
{
    this->dadd_var = dadd;
}
