...
void DL_PDU::copy(const DL_PDU& other)
{
    ...
    this->isDlLayer_var = other.isDlLayer_var;
...
void DL_PDU::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->isDlLayer_var);
...
void DL_PDU::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->isDlLayer_var);
...
bool DL_PDU::getIsDlLayer() const
{
    return isDlLayer_var;
}

void DL_PDU::setIsDlLayer(bool isDlLayer)
{
    this->isDlLayer_var = isDlLayer;
}
...
int DL_PDUDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "isDlLayer")==0) return base+2;
...
std::string DL_PDUDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return bool2string(pp->getIsDlLayer());
        case 3: return long2string(pp->getSrc());
        case 4: return long2string(pp->getDest());
        default: return "";
    }
}
...
bool DL_PDUDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setIsDlLayer(string2bool(value)); return true;
        case 3: pp->setSrc(string2long(value)); return true;
        case 4: pp->setDest(string2long(value)); return true;
