...
simtime_t A_PDU::getSenderTime() const
{
    return senderTime_var;
}

void A_PDU::setSenderTime(simtime_t senderTime)
{
...
int A_PDUDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderTime")==0) return base+4;
...
std::string A_PDUDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return double2string(pp->getSenderTime());
        default: return "";
    }
}
...
bool A_PDUDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setSenderTime(string2double(value)); return true;
